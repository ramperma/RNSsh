...
_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "app.brand": "RNSsh",
        "app.subtitle": "Double-click a host to connect.",
        "toolbar.main": "Main",
        "action.add": "Add",
        "action.edit": "Edit",
        ...
        "empty.hint": "Add a host, then double-click it to connect.",
        "empty.add": "Add host",
        "filter.empty": "No hosts match “{query}”.",
        "tray.show": "Open RNSsh",
        "tray.quit": "Quit",
        "tray.close_title": "Close RNSsh",
        "tray.close_prompt": "Keep RNSsh running in the system tray?",
        "tray.close_hint": "Minimize hides this window and leaves an icon in the tray. Quit closes the program.",
        "tray.minimize": "Minimize to tray",
        "tray.minimized": "RNSsh is still running",
        "tray.minimized_hint": "Click the tray icon to open the window again.",
        "col.name": "Name",
        "col.target": "Target",
    ...
    "es": {
        ...
        "app.brand": "RNSsh",
        "app.subtitle": "Doble clic en un host para conectar.",
        ...
        "search.placeholder": "Buscar hosts…",
        "empty.title": "Aún no hay conexiones",
        "empty.hint": "Añada un host y haga doble clic para conectar.",
        "empty.add": "Añadir host",
        "filter.empty": "Ningún host coincide con “{query}”.",
        "tray.show": "Abrir RNSsh",
        "tray.quit": "Salir",
        "tray.close_title": "Cerrar RNSsh",
        "tray.close_prompt": "¿Dejar RNSsh en ejecución en la bandeja del sistema?",
        "tray.close_hint": "Minimizar oculta esta ventana y deja un icono en la bandeja. Salir cierra el programa.",
        "tray.minimize": "Minimizar a la bandeja",
        "tray.minimized": "RNSsh sigue en ejecución",
        "tray.minimized_hint": "Pulse el icono de la bandeja para abrir la ventana.",
        "col.name": "Nombre",
        "col.target": "Destino",
